...
function H({ children, bp }) {
  return <h2 style={{ fontFamily: "var(--font-display)", fontWeight: "var(--weight-semibold)", fontSize: bp.mobile ? "var(--text-lg)" : "var(--text-xl)", color: "var(--navy-900)", margin: "34px 0 12px" }}>{children}</h2>;
}
...
function ConsentBox({ bp }) {
  return (
    <div style={{ background: "var(--navy-050)", border: "1px solid var(--ink-100)", borderLeft: "4px solid var(--gold-500)", borderRadius: "var(--radius-md)", padding: bp.mobile ? "16px 18px" : "20px 24px", margin: "0 0 20px" }}>
...
export default function LegalPage() {
  ...
  return (
    <div style={{ background: "var(--paper)", minHeight: "100vh" }}>
      <WhatsAppButton />
      <NavBar active="" />
      <section style={{ background: "linear-gradient(150deg,var(--navy-950) 0%,var(--navy-900) 55%,var(--navy-800) 100%)", padding: bp.mobile ? "44px 20px" : "64px 32px", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", maxWidth: 820, margin: "0 auto" }}>
          ...
          <h1 style={{ fontFamily: "var(--font-display)", fontWeight: "var(--weight-bold)", fontSize: bp.mobile ? "var(--text-2xl)" : "var(--text-4xl)", color: "var(--white)", margin: 0 }}>
      ...
      <section style={{ padding: bp.mobile ? "32px 20px 72px" : "48px 32px 96px", maxWidth: 820, margin: "0 auto" }}>
        ...
        {isTerms ? (
          <>
            ...
            <H bp={bp}>Communication consent</H>
            <ConsentBox bp={bp} />
            <H bp={bp}>Scope of services</H>
            ...
            <H bp={bp}>Limitation of liability</H>
          ...
          <>
            ...
            <H bp={bp}>Information we collect &amp; your consent</H>
            <ConsentBox bp={bp} />
            <H bp={bp}>How we use your information</H>
