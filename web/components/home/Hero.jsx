...
export function Hero() {
  ...
  return (
    <section style={{ position: "relative", background: "var(--white)" }}>
      <div
        className="rsp-2col hero-section-grid"
        style={{
          position: "relative", maxWidth: "var(--container-max)", margin: "0 auto", display: "grid",
          gridTemplateColumns: "1.05fr .95fr", gap: 60, alignItems: "center",
          padding: "72px 32px 80px",
        }}
      >
        <div className="hero-text-block">
          <Eyebrow>All Systems Compliant · Since 2017</Eyebrow>
          <h1 className="hero-h1" style={{ fontFamily: "var(--font-display)", fontWeight: "var(--weight-semibold)", fontSize: "var(--text-6xl)", color: "var(--navy-900)", margin: "20px 0 20px", letterSpacing: "var(--tracking-tight)", lineHeight: 1.06 }}>
            Business compliance,
            <br />
            made{" "}
          ...
          <div className="hero-cta-row" style={{ display: "flex", gap: 14, marginBottom: 40, flexWrap: "wrap" }}>
          ...
          <div className="hero-stats-row" style={{ display: "flex", gap: 36, flexWrap: "wrap" }}>
            <div>
        ...
        <div className="hero-illustration" style={{ position: "relative", height: 560, width: "100%" }}>
          ...
          <div className="hero-servicefinder" style={{ position: "absolute", right: 0, top: "8%", zIndex: 4, width: "64%", minWidth: 290 }}>
